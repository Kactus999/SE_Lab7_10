...
namespace LabWebmvc.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,OrderID,ItemID,Quantity")] OrderDetail orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,OrderID,ItemID,Quantity")] OrderDetail orderDetail)
        {
            if (ModelState.IsValid)
            {
